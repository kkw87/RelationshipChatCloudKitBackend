...
//  RelationshipChat
//
//  Created by Kevin Wang on 2/8/17.
...
class ActivityView: UIView {
    ...
    required init(coder aDecoder: NSCoder) {
        fatalError("unit(coder:) has not been implemented")
    }
    ...
    override func layoutSubviews() {
        ...
        let messageLabelSize = messageLabel.sizeThatFits(CGSize(width: 160.0 - 20.0 * 2, height: CGFloat.greatestFiniteMagnitude))
    ...
    func updateMessageWith(message : String) {
